...
public class Navigation {
	...
	try {	
		...
		String update = "UPDATE "+mssqlConnection.getDatabase()+".dbo.articles SET " +
	...
	try {	
		...
		String addNavigation = "INSERT "+mssqlConnection.getDatabase()+".dbo.navigations " +
				"(navigationName, navigationURL, navigationVisible, navigationOrder) VALUES (?,?,?,?)";
		
		PreparedStatement ps = connection.prepareStatement(addNavigation);
