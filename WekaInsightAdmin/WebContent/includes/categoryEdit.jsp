...
<div class="form-group col-xs-12 col-md-6">
	 ...
	 <select class="form-control" id="categoryVisible" name="categoryVisible">
...
<div class="form-group">
	<span>
     	<button class="btn btn-primary"  type="submit" onclick="updateCategory()" id="categoryEdit" data-toggle="tooltip" title="Edit Category">Save Changes</button>
	</span>

 	<span>
     	<button class = "btn btn-link" type="button" onclick="window.history.back()" data-toggle="tooltip" title="Cancels editting the Category, and refreshes this webpage.">Cancel</button>
   	</span>
</div>   
